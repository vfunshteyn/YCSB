 ...
 *      Java Driver</a>
 */
public class AsyncMongoDbClient extends MongoDbClient {
...
//
//  /** The write concern for the requests. */
//  private static MongoClient writeConcern;
//
...
//    for (final Object o : queryResult.values()) { // XXX
//      Element be = (Element)o;
