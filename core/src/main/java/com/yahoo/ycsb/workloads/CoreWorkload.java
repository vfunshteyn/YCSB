...
public class CoreWorkload extends Workload {
   ...
   */
  NumberGenerator<? extends Number> fieldlengthgenerator;
  ...
  NumberGenerator<Integer> keysequence;

  DiscreteGenerator operationchooser;

  NumberGenerator<? extends Number> keychooser;

  NumberGenerator<Integer> fieldchooser;

  AcknowledgedCounterGenerator transactioninsertkeysequence;

  NumberGenerator<? extends Number> scanlength;
  ...
  protected static NumberGenerator<? extends Number> getFieldLengthGenerator(Properties p) throws WorkloadException {
    NumberGenerator<? extends Number> fieldlengthgenerator;
  ...
  private HashMap<String, ByteIterator> buildSingleValue(String key) {
    ...
    String fieldkey = fieldnames.get(fieldchooser.nextValue());
    ByteIterator data;
    if (dataintegrity) {
  ...
  public boolean doInsert(DB db, Object threadstate) {
    int keynum = keysequence.nextValue();
  ...
  public void doTransactionRead(DB db) {
    ...
    if (!readallfields) {
      // read a random field
      String fieldname = fieldnames.get(fieldchooser.nextValue());
